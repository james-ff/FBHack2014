...
- (id)initWithCoder:(NSCoder *)aDecoder
{
    if (self = [super initWithCoder:aDecoder]) {
        ...
        _displayNameLabel.textColor = [UIColor colorWithRed:34.0/255.0
                                                      green:97.0/255.0
                                                       blue:221.0/255.0
                                                      alpha:1];
...
- (void)setTranscript:(Transcript *)transcript
{
    ...
    _displayNameLabel.frame = CGRectMake(xOffset,
                                         1,
                                         nameSize.width,
                                         nameSize.height);
    
    _progressView.frame = CGRectMake(xOffset,
                                     yOffset + 5,
                                     PROGRESS_VIEW_WIDTH,
...
{
    return [string boundingRectWithSize:CGSizeMake(PROGRESS_VIEW_WIDTH, 2000.0)

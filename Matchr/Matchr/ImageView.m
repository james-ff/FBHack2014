...
- (void)setTranscript:(Transcript *)transcript
{
    ...
    _nameLabel.frame = CGRectMake(xOffsetBalloon,
                                  1,
                                  nameSize.width,
                                  nameSize.height);
    
    _imageView.frame = CGRectMake(xOffsetBalloon,
                                  yOffset,
                                  width,
                                  height);
}
...
{
    return [string boundingRectWithSize:CGSizeMake(DETAIL_TEXT_LABEL_WIDTH, 2000.0)
